public class BankAccount{
	...
	public void deposit(double money){  //deposit method to deposit money into account
		...
		if (money < 0){           //if statement to not be able to deposit negative amount
			balance = balance;
		}
		else{
	...
	public void withdraw(double money){      //withdraw method to withdraw money from account
		if (balance <= 0){
			if (money >= overdraftAmount){    // if statement to not be able to withdraw more than overdraft amount
