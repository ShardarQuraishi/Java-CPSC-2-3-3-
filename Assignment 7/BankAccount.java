...
public abstract class BankAccount {
    ...
    /**
     * Abstract method for getting the monthly fees and interest.
     * @return fees
     */
    protected abstract double getMonthlyFeesAndInterest();

    /**
     * Method updates the balance based on the amount returned by the
     * getMonthlyFeesAndInterest method.
     */
